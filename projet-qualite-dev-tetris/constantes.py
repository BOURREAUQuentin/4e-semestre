# définition des constantes pour les dimensions du jeu
TAILLE_FENETRE = 640, 480
DIM_PLATEAU = 10, 20
BORDURE_PLATEAU = 4
TAILLE_BLOC = 20, 20

# Calcul des autres dimensions du jeu en fonction des constantes au-dessus
...
# définition des formes de chaque pièce du jeu Tetris
PIECES = {
    'O': ['0000\n0110\n0110\n0000',],
    'S': [
        '0000\n0022\n0220\n0000',
...
# définition des couleurs pour les cases du jeu
COULEURS = {
    0: (0, 0, 0),
    1: (255, 255, 0),
    2: (0, 255, 0),
