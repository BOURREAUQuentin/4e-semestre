...
public class MotMystere {
    ...
    /**
     * le nom du fichier du dictionnaire
     */
    private String nomFichier;
    /**
     * la longueur min d'un mot
     */
    private int longMin;
    /**
     * la longueur max d'un mot
     */
    private int longMax;
     ...
     * @param motATrouver mot à trouver
    ...
    /**
     * change la longueur maximum d'un mot en changeant le dictionnaire
     * @param longMax la longueur max d'un mot
     */
    public void setLongueurMaxMot(int longMax){
        this.longMax = longMax;
        this.dict = new Dictionnaire(this.nomFichier,this.longMin,this.longMax);
    }
